...
public class EditDistance implements Metric
{
    ...
    /**
     * Default constructor, gap cost (insert/delete cost) =1, substitution cost =1;
     */
     public EditDistance()
     {
         this(1,1);
     ...
     /**
      * Constructor, the two arguments should satisfy gapCost/2 <= substitutionCost <= gapCost *2
      * @param gapCost insert/delete cost
      * @param substitutionCost substitution cost.
      */
  ...
  */
  ...
  {  
      ...
      for (int i = 1; i <= firstSize; i++) 
      {
          ...
          {
              cost = ( firstChar == second.charAt (j - 1) )? 0 :substitutionCost ;
