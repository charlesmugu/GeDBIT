...
//        String [] pivotString = new String [] {"1-256", "2-16", "3-6", "4-4", "5-3", "6-2", "7-2", "8-2"};
        ...
        System.out.print("Arguments  = -Xmx1800m -cp .:../jdb2/lib/colt.jar:../jdb2/src GeDBIT.app.BuildVPIndex -n " + input);
...
//        String dir = "dim8";
        ...
        {
        System.out.println("Arguments  = -Xmx1800m -cp .:../jdb2/lib/colt.jar:../jdb2/src GeDBIT.app.BuildVPIndex -n " + input
    ...
    public static void fftscaleQueryCondor() throws Exception
    {
        ...
        for (int q = 0; q < querySet; q++)
        {
            for (int scale = 1; scale <= fftscale; scale++)
            {
                ...
                System.out.print("Arguments  = -Xmx1800m -cp .:../jdb2/lib/colt.jar:../jdb2/src GeDBIT.app.QueryVPIndex -d ../result/db/fftscale/dim"
                        + dim);
...
//        texas-3-3-100-inc-clustering-a30k-n10-db0-100000.000
        ...
        for (int q = 0; q < querySet; q++)
        {
            for (int d = 0; d < db; d++)
            {
                System.out.println("Arguments  = -Xmx1800m -cp .:../jdb2/lib/colt.jar:../jdb2/src GeDBIT.app.QueryVPIndex -d ../result/db/inc/"
