...
public class GlobalIndexWorkTask implements Task
{
    ...
    public GlobalIndexWorkTask(int threadID, Metric metric, long rootAddress, double[] distList,
            int counter, double radius, String forprint)
    {
        this(threadID, metric, rootAddress, distList, counter, radius, forprint, null);
    }
    
    public GlobalIndexWorkTask(int threadID, Metric metric, long rootAddress, double[] distList,
            int counter, double radius, String forprint, CountDownLatch latch)
    {
    ...
    public void execute()
    {
        try {
            ...
            index.query(metric, rootAddress, distList, counter, radius, forprint);
