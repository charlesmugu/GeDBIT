/**
 * edu.utexas.GeDBIT.mckoi.util.UserTerminal  12 Apr 2001
 *
...
/**
 * An interface that represents a terminal that is asked questions in human and
 * machine understandable terms, and sends answers. This interface is intended
 * for an interface in which the user is asked questions, or for an automated
 * tool.
 * 
