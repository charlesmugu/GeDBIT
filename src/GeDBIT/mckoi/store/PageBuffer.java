...
abstract class PageBuffer {
   ...
   * we just return.  If it's not initialized we set up any internal structures
   ...
   * to the page and the page is initialized).  When disposed any internal
   * resources are reclaimed.  The page may later be initialized again if
   * required.
   */
  ...
  /**
   * Flushes the information buffered by this page to the disk.  This may
   * write nothing if it is determined that no data in the page was changed.
   */
  ...
  protected abstract void readImpl(int position,
                            byte[] buf, int off, int len) throws IOException;
  protected abstract void writeImpl(int position, byte val)
                                                          throws IOException;
  protected abstract void writeImpl(int position,
                            byte[] buf, int off, int len) throws IOException;
