...
/**
 * An interface that represents an area of a store that has been allocated. The
 * area object maintains a pointer that can be manipulated and read and written
 * to. This interface is modelled on the java.nio.Buffer interface and should be
 * easily interchanged with it.
 * 
