...
public class DNATable extends SequenceTable {
     ...
     * @throws IOException
     */
    public DNATable(String fileName, String indexPrefix, int maxDataSize, int fragmentLength)
            throws IOException {
     ...
     * @throws IOException
     */
    public DNATable(String fileName, String indexPrefix, int maxDataSize, SequenceFragmentMetric metric, int fragmentLength) throws IOException {
