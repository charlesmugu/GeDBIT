...
public abstract class TableMR implements Serializable
{
            ...
            boolean bucket, Level debugLevel, String forPrint)
    {
        ...
        //indexFileName = createIndexFileName(psm, numPivots, pm, singlePivotFanout, maxLeafSize, maxPathLength, bucket);
        ...
        if (bucket == true)
        {
            ...
            /* temporary use to output distinct points
            for (int i=0; i<data.size(); i++)
            {
                GeDBIT.type.DoubleVector v = (GeDBIT.type.DoubleVector)data.get(i);
