...
/**
 * A <code>Peptide</code> is a compact representation of a AminoAcids sequence(Peptide). Each AminoAcids is stored as a byte.
 * @author Rui Mao
 * @version 2003.06.06
 */
public class Peptide extends Sequence
{
    ...
    {
        A("Ala", "Alanine", (byte) 0), R("Arg", "Arginine", (byte) 1), N("Asn", "Asparagine", (byte) 2), D("Asp", "Aspartic acid", (byte) 3), C(
                "Cys", "Cysteine", (byte) 4), Q("Gln", "Glutamine", (byte) 5), E("Glu", "Glutamic acid", (byte) 6), G("Gly", "Glycine", (byte) 7), H(
                "His", "Histidine", (byte) 8), I("Ile", "Isoleucine", (byte) 9), L("Leu", "Leucine", (byte) 10), K("Lys", "Lysine", (byte) 11), M(
                "Met", "Methionine", (byte) 12), F("Phe", "Phenylalanine", (byte) 13), P("Pro", "Proline", (byte) 14), S("Ser", "Serine", (byte) 15), T(
                "Thr", "Threonine", (byte) 16), W("Trp", "Tryptophan", (byte) 17), Y("Tyr", "Tyrosine", (byte) 18), V("Val", "Valine", (byte) 19), B(
                "Unk", "Unknown", (byte) 20), Z("Unk", "Unknown", (byte) 20), U("Unk", "Unknown", (byte) 20), X("Unk", "Unknown", (byte) 20);
    ...
    public static final Alphabet ALPHABET = new Alphabet(AminoAcid.values(), AminoAcid.distinctSize());
    ...
    public Peptide(String sequenceID, String sequence)
    {
        ...
        {
            data[i] = (AminoAcid.valueOf(sequence.substring(i, i + 1))).byteValue();
        }
    }
    ...
    public final static WeightMatrix mPAM250aExtendedWeightMatrix = new SymmetricSubstitutionWeightMatrix(ALPHABET, new double[][] {
